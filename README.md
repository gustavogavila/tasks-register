...
* The original package name 'com.gus.tasks-register' is invalid and this project uses 'com.gus.tasksregister' instead.
...
* [Flyway Migration](https://docs.spring.io/spring-boot/docs/3.0.12/reference/htmlsingle/index.html#howto.data-initialization.migration-tool.flyway)
* [Spring Batch](https://docs.spring.io/spring-boot/docs/3.0.12/reference/htmlsingle/index.html#howto.batch)
